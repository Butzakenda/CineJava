...
public class CrearPelicula extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nuevas Peliculas");
    ...
    private void jButton1btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1btnGuardarActionPerformed
        ...
        String FechaEmision = jTextField4.getText();
        String Categoria = jTextField5.getText();
        String Precio = jTextField6.getText();
       
        
        if(guardar){
            ControladoresPeliculas control = new ControladoresPeliculas();
            control.insertar(Nombre, Genero, Tipo, FechaEmision, Categoria, Precio);
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
            jTextField4.setText("");
