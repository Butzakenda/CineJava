 ...
 * @author user
 */
public class PeliculasEliminar extends javax.swing.JFrame {

    /**
     * Creates new form ClientesEliminar
     */
    public PeliculasEliminar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeliculasEliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PeliculasEliminar().setVisible(true);
            }
        });
    }
