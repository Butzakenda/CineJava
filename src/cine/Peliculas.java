...
public class Peliculas extends javax.swing.JFrame {
    ...
    public void configurarTabla() {
        String titulosTabla[] = {"IdPelicula", "Nombre","Genero", "Tipo", "FechaEmision","Categoria", "Precio"};
    ...
    private void cargarDatos() {
        try {
            ...
            String consulta = "SELECT IdPelicula, Nombre, Genero, Tipo, FechaEmision, Categoria, Precio FROM peliculas";
            ...
            while (rs.next()) {
                ...
                Object[] fila = {IdPelicula, Nombre, Genero, Tipo, FechaEmision, Categoria, Precio};
                tabla.addRow(fila);
            }
    ...
    private void btnAgregarFilaDatos(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarFilaDatos
        ...
        CrearPelicula m = new CrearPelicula();
        m.setVisible(true);
