...
public class Clientes extends javax.swing.JFrame {
    ...
    public void configurarTabla() {
        String titulosTabla[] = {"IdCliente", "Nombres","Apellidos", "TipoDocumento", "NumDocumento","CorreoElectronico"};
    ...
    private void cargarDatos() {
        try {
            ...
            String consulta = "SELECT IdCliente, Nombres, Apellidos, TipoDocumento, NumDocumento, CorreoElectronico FROM clientes";
            ...
            while (rs.next()) {
                ...
                Object[] fila = {idCliente, nombre, apellidos, TipoDocumento, NumDocumento, email};
                tabla.addRow(fila);
            }
    ...
    private void btnAgregarFilaDatos(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarFilaDatos
        ...
        CrearClienteOriginal m = new CrearClienteOriginal();
        m.setVisible(true);
